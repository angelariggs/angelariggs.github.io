...
Earlier this year I had a fantastic guest post from Mojtaba Hosseini, a Director of Engineering at Zapier, talking about the [12 pitfalls]({% post_url 2022-01-18-pitfalls-of-engineering-metrics %}) of engineering metrics. As Moj and Zapier are going through their journey of becoming a more metric-driven engineering organization, he's capturing his previous journeys around metrics in the hope that those lessons learned can help inform the journey at Zapier (and hopefully help you, too 😄)! So grab your favorite snack and settle in for the first episode in Moj's metrics series 🍿

## The One Where Questions Lead to a Shocking Metric

When I joined the last engineering organization, we had no metrics at all. None! I had recently read [the book Accelerate and so the 4 DORA metrics](https://www.amazon.ca/Accelerate-Software-Performing-Technology-Organizations/dp/1942788339/) were very top of mind. I figured we would start with the 2 of the easier ones to measure (focused on velocity), leaving the more difficult ones (focused on quality) for later:
...
(For comparison, organizations in ‘elite’ category, deployment 10s or 100s times a day and have lead times of minutes and hours)
